...
import solutions.it.zanjo.travease.Activities.ServiceRequest2Activity;
...
public class Service2Adapter extends BaseAdapter {

    private ServiceRequest2Activity _context =null;
    private ArrayList<Service> _addDatas = new ArrayList<Service>();


    public Service2Adapter(ServiceRequest2Activity _context){
